...
if status is "Top 10 handsets used by the customers":
    ...
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/top 5 handset.png")
...
if datausage:
    ...
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/total data usage each app.png")
...
if correlation:
    ...
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/Application Data Correlation.png")
...
if traffic:
    ...
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/top 10 most engaged users per application.png")
...
if option is "TCP values in the dataset":
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/TCP values in the dataset..png")
    ...
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/RTT values in the dataset..png")
    ...
    st.image("C:/Users/User/Telecommunication_Industry/venv/my_streamlit_app/telco images/Throughput values in the dataset..png")
